    ...
    <el-form class="login-form" autoComplete="on" :model="registerForm" :rules="loginRules" ref="registerForm" label-position="left">
      ...
      <el-form-item prop="password">
       ...
       <el-form-item prop="re_password">
        ...
        <el-input name="re_password" :type="pwdType" @keyup.enter.native="handleRegister" v-model="registerForm.re_password" autoComplete="on"
          placeholder="password"></el-input>
          <span class="show-pwd" @click="showPwd"><svg-icon icon-class="eye" /></span>
      </el-form-item>
      ...
      <div class="tips">
        <span style="margin-right:150px;"><a class="link" href="#/login">Already have</a></span>
        <span><a class="link" href="#/register/employer">Register as employer </a></span>       
  ...
  methods: {
    ...
    handleRegister() {
      this.$refs.registerForm.validate(valid => {
        if (valid) {
          this.loading = true
          this.$store.dispatch('RegisterByAdmin', this.registerForm).then(() => {
            this.loading = false
